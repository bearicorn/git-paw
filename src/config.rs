...
//! and per-repo (`.git-paw.toml`) files. Supports custom CLI definitions,
...
/// Returns the path to a repo-level config file (`.git-paw.toml`).
pub fn repo_config_path(repo_root: &Path) -> PathBuf {
    repo_root.join(".git-paw.toml")
}

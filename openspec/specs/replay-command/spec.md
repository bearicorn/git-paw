...
Replay captured session logs from git-paw sessions, supporting listing available sessions, displaying logs with ANSI codes stripped or preserved, fuzzy branch matching, and automatic selection of the most recent session.

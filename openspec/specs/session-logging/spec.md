...
Capture raw terminal output from each tmux pane to per-branch log files using tmux pipe-pane, supporting session log directory creation, filename sanitization, and enumeration of available logs.

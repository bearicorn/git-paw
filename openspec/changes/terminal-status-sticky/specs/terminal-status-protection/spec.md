...
Define terminal agent states and the protection rules in `update_agent_record` that prevent terminal states from being downgraded by transient watcher or message updates.
